...
const { createSampleServices } = require('../../helpers/fixtures');
...
describe('Quickbar Injector', () => {
  ...
  describe('injectServices', () => {
    ...
    it('should filter out duplicates of native AWS favorites', async () => {
      ...
      const services = [
        { id: 's3', name: 'S3', consoleUrl: 'https://console.aws.amazon.com/s3/home', source: 'user' },
        { id: 'ec2', name: 'EC2', consoleUrl: 'https://console.aws.amazon.com/ec2/home', source: 'user' }
      ];
    ...
    it('should apply CSS classes from native favorites when available', async () => {
      ...
      const services = [
        { id: 'lambda', name: 'Lambda', consoleUrl: 'https://console.aws.amazon.com/lambda/home', source: 'user' }
      ];
    ...
    it('should remove previously injected services before adding new ones', async () => {
      ...
      await window.AWSFavoritesQuickbar.injectServices(services1, quickbar);
      ...
      await window.AWSFavoritesQuickbar.injectServices(services2, quickbar);
    ...
    it('should return false when quickbar is not found', async () => {
      ...
      const result = await window.AWSFavoritesQuickbar.injectServices(services);
    ...
    it('should handle errors gracefully', async () => {
      ...
      const result = await window.AWSFavoritesQuickbar.injectServices(invalidServices, quickbar);
